...
/*********************  ZFCandleChartDelegate(ZFCandleChart协议方法)  *********************/
@protocol ZFCandleChartDelegate <NSObject>
 ...
 *
 *  @param candleIndex 点击的circle在第几条线
 ...
 *
 *  @param candleIndex 点击的label在第几组
 *  @param circleIndex 点击的label在该组的下标
 */
...
@interface ZFCandleChart : ZFGenericChart

@property (nonatomic, weak) id<ZFCandleChartDelegate> delegate;
